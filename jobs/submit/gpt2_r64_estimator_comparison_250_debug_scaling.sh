...
STAGING_ROOT="${STAGING_ROOT:-${REPO_DIR}/tmp/gpt2_r64_estimator_comparison_250_debug_scaling}"
...
for mode in k2 k3 frankenstein hajek; do
  add_or_skip_run \
...
MANIFEST_FILE="${STAGING_DIR}/manifest.gpt2_r64_estimator_comparison_250_debug_scaling.txt"
