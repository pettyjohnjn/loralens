...
BASE_OUT="${BASE_OUT:-${REPO_DIR}/src/checkpoints/gpt2_subset_k2_k3_lr_sweep_250_debug_scaling}"
STAGING_ROOT="${STAGING_ROOT:-${REPO_DIR}/tmp/gpt2_subset_k2_k3_lr_sweep_250_debug_scaling}"
LOG_SUBDIR="${LOG_SUBDIR:-gpt2_subset_k2_k3_lr_sweep_250_debug_scaling}"
...
echo "Budget: head+tail ${HEAD_K}+${TAIL_K}"
...
MANIFEST_FILE="${STAGING_DIR}/manifest.gpt2_subset_k2_k3_lr_sweep_250_debug_scaling.txt"
