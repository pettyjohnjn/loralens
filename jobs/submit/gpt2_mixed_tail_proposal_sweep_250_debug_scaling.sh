...
BASE_OUT="${BASE_OUT:-${REPO_DIR}/src/checkpoints/gpt2_mixed_tail_proposal_sweep_250_debug_scaling}"
STAGING_ROOT="${STAGING_ROOT:-${REPO_DIR}/tmp/gpt2_mixed_tail_proposal_sweep_250_debug_scaling}"
LOG_SUBDIR="${LOG_SUBDIR:-gpt2_mixed_tail_proposal_sweep_250_debug_scaling}"
...
HEAD_K="${HEAD_K:-256}"
TOPK_K="${TOPK_K:-512}"
SUBSET_KL_MODE="${SUBSET_KL_MODE:-hajek}"
...
MANIFEST_FILE="${STAGING_DIR}/manifest.gpt2_mixed_tail_proposal_sweep_250_debug_scaling.txt"
